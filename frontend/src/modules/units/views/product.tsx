...
const Product: React.FC = () => {
  const [rows, setRows] = useState<ProdcutData[]>([]);
  ...
  return (
    <RootPage>
      ...
      <HeaderContainer>
        <PageTitle>BẢNG ĐỐI SÁNH MÃ SẢN PHẨM</PageTitle>
          ...
          <Table stickyHeader size="small">
            <TableHead>
              <TableRow>
                ...
                <StyledTableHeadCell sx={{ textAlign: 'left !important' }}>Mô tả thông tin sản phẩm</StyledTableHeadCell>
      ...
      >
        ...
        <CustomDialogContent>
          <Grid container spacing={3}>
            ...
            {/* Hàng 2: Mô tả */}
            <Grid size={{ xs: 12 }}>
              <LabelText>Mô tả thông tin sản phẩm</LabelText>
              <ModalTextField placeholder="Mô tả thông tin sản phẩm" variant="outlined" />
            </Grid>
          </Grid>
        </CustomDialogContent>
