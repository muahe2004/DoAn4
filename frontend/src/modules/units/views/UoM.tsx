  ...
  return (
    <Box className="root-page">
      <Box className="breadcrumb-container">
        ...
        <span className="separator">/</span>
        <span className="current-step">Chuyển đổi đơn vị tính(Nội bộ - Hải quan)</span>
      </Box>

      <Typography className="page-title">
        BẢNG ĐỐI SÁNH ĐƠN VỊ TÍNH
      </Typography>
          ...
          <Table stickyHeader size="small">
            <TableHead>
              <TableRow>
                ...
                <TableCell className="table-header-cell" align="left" sx={{ width: 180, pl: 2.5 }}>Mã đơn vị nội bộ</TableCell>
                <TableCell className="table-header-cell" align="left" sx={{ width: 140 }}>Mã đơn vị hải quan</TableCell>
                <TableCell className="table-header-cell" sx={{ width: 120 }}>Ngày thêm</TableCell>
                <TableCell className="table-header-cell" align="left">Mô tả thông tin đơn vị tính</TableCell>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} maxWidth="md" fullWidth>
        ...
        <DialogContent sx={{ p: 3 }}>
          <Grid container spacing={3} sx={{ mt: 0.5 }}>
            <Grid size={6}>
              <label className="label-input">Mã đơn vị hải quan <span>*</span></label>
              <TextField fullWidth size="small" placeholder="Mã hải quan" />
            </Grid>
            <Grid size={6}>
              <label className="label-input">Mã đơn vị nội bộ <span>*</span></label>
