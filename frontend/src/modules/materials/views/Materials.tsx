...
export function Materials() {
    ...
    const [selectedMaterial, setSelectedMaterial] = useState<IMaterialResponse | null>(null);
    ...
    const { handleSubmitMaterial, handleDeleteMaterial, isSubmitting } = useMaterialHandlers({
        selectedMaterial,
        ...
        <Container maxWidth={false} className="primary-container">
            <div className="material-header">
                <div className="material-title">
                    <p className="material-title__label">DANH MỤC NGUYÊN VẬT LIỆU KHO/KẾ TOÁN</p>
                </div>
                <div className="material-actions">
                    <SearchEngine placeholder="Tên nguyên vật liệu, mã..." onSearch={handleSearch} />
                    <div className="material-actions__buttons">
                        <Button className="material-action-btn" onClick={handleExportTemplate}>
